...
public strictfp class MatterStack
{
	...
	public ComplexMatrix getLocalPropagationMatrix(int index, double energy)
	{
		...
		Complex p;
		// Double.POSITIVE_INFINITY is handled here and it assigns to
		// real part
	...
	// if (VERBOSE) {
	// System.out.println("Propagation value for index" + index +
	// " and energy "
	// + energy);
...
//			}
	 ...
	 * 
	 * @param number
	 *            number of states starting with the lowest one (not implemented yet)
	 */
