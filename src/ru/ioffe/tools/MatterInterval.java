...
public  strictfp class MatterInterval extends Interval {
	...
	private double acceptorConcentration;
	private double donorConcentration;
	private double electronsConcentration;
	private double holesConcentration;
	...
	public String toString() {
		return String.format("[%.2e, %.2e]\tY: %.3f\tmass: %.4f\tdiel: %.1f\t%s", x_start, x_end, Utils.erg2ev(y), mass, dielectricConstant, label);
	}

	public double getAcceptorConcentration() {
		return acceptorConcentration;
	}

	public void setAcceptorConcentration(double acceptorConcentration) {
		this.acceptorConcentration = acceptorConcentration;
	}

	public double getDonorConcentration() {
		return donorConcentration;
	}

	public void setDonorConcentration(double donorConcentration) {
		this.donorConcentration = donorConcentration;
	}

	public double getElectronsConcentration() {
		return electronsConcentration;
	}

	public void setElectronsConcentration(double electronsConcentration) {
		this.electronsConcentration = electronsConcentration;
	}

	public double getHolesConcentration() {
		return holesConcentration;
	}

	public void setHolesConcentration(double holesConcentration) {
		this.holesConcentration = holesConcentration;
	}
	...
	public static void main(String[] args) {
		...
		// System.out.println(1.0 / 0); // Infinity (Double.POSITIVE_INFINITY)
