...
public  strictfp class Interval {
	...
	/**
	 * Initializing Interval object without x axis data (x defaults from 0 to 1)
	 * 
	 * @param y_start
	 * @param angle
	 */
	...
	/**
	 * Get x coordinates for the curve building of wave functions and potential
	 * profiles. This method doesn't require equality of intervals in a stack
	 * 
	 * @param density
	...
	/**
	 * Get local x coordinates of the interval for the curve building of wave
	 * functions and potential profiles. This method doesn't require equality of
	 * intervals in a stack
	 * 
	 * @param density
	 *            number of dots per 1 cm
	 * @return x coordinates in the interval instance for wave functions and
	...
	public static void main(String[] args) {
		...
		Interval i2 = new Interval(i1.getXEnd(), i1.getXEnd() + step,
				i1.getY() / 2);
		Interval i3 = new Interval(i2.getXEnd(), i2.getXEnd() + step,
				i2.getY() * 2);
