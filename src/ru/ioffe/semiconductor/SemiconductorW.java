...
public strictfp class SemiconductorW {
	 ...
	 * @param mass_elx
	 *            Electron effective mass in x direction, in units of free
	 *            electron mass
	 * @param mass_elz
	 *            Electron effective mass in z direction, in units of free
	 *            electron mass
	 * @param mass_hhx
	 *            Heavy hole effective mass in x direction, in units of free
	 *            electron mass
	 * @param mass_hhz
	 *            Heavy hole effective mass in z direction, in units of free
	 *            electron mass
	 * @param mass_lhx
	 *            Light hole effective mass in x direction, in units of free
	 *            electron mass
	 * @param mass_lhz
	 *            Light hole effective mass in z direction, in units of free
	 *            electron mass
	 * @param c11
	...
	public SemiconductorW(double a, double c, double a_0, double c_0, double a_Tch, double c_Tch, double a_TEC, double c_TEC,
			double energy_gap, double energy_gap_0, double alpha, double beta, double mass_elx, double mass_elz, double mass_hhx,
			double mass_hhz, double mass_lhx, double mass_lhz, double c11, double c12, double c13, double c33, double c44,
			double pz13, double pz33, double pz15, double polar_sp, double diel, double T) {
		this.a = a;
		this.c = c;
		this.a_0 = a_0;
		this.c_0 = c_0;
