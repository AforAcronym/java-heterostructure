...
public strictfp class Utils {
     ...
     * Vegard's law
     *
     * @param x      compound in A(x)B(1-x)
     * @param par1   any property of A(x)
     * @param par2   any property of B(1-x)
     * @param bowing bowing factor
     ...
     * @param e0    energy gap at 0 K in eV
     * @param alpha eV/K
     * @param beta  K
     ...
     *
     * @param x    use to be temperatures ratio
     * @param prec precision, defines number of steps from 0 to 1
     ...
     *
     * @param x usually a temperatures ratio
     ...
     *
     * @param f electric field in V/cm
     ...
     *
     * @param f electric field in CGS units
    ...
    /**
     * Convertor from electronvolts to nanometers and in reverse
     *
     * @param par either in electronvolts or in nanometers
     */
    public static double convertNmEv(double par) {
        return ru.ioffe.semiconductor.General.NM_EV_COEF / par;
    }
}
